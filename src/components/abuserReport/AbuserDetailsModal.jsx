...
const downloadFile = async ({ url, onProgress }) => {
  const filename   = url.split('/').pop().split('?')[0] || `evidence_${Date.now()}`;
      ...
      >
        {isActive ? (
          <View style={styles.downloadBtnInner}>
            <ActivityIndicator size="small" color="#E53E6D" />
      ...
      <Animated.View style={[styles.sheet, { transform: [{ translateY: slideAnim }] }]}>
        ...
        >
          ...
          <View style={styles.card}>
            <InfoRow label="Type of Abuse" value={abuseType}               highlight />
            <InfoRow label="Incident Date" value={formatDate(incidentDate)} />
            <InfoRow label="Location"      value={incidentLocation} />
            <InfoRow label="Report Filed"  value={formatDate(createdAt)} />
          </View>
...
const styles = StyleSheet.create({
  ...
  avatarImg: { resizeMode: 'cover', borderWidth: 2, borderColor: 'rgba(255,255,255,0.15)' },
  avatarFallback: {
    backgroundColor: '#1E2D45',
    alignItems: 'center', justifyContent: 'center',
    borderWidth: 1.5, borderColor: 'rgba(255,255,255,0.12)',
  },
  avatarInitials: { color: '#8BA7CC', fontWeight: '700', letterSpacing: 1 },

  heroMeta:  { flex: 1 },
  heroName:  { color: '#FFFFFF', fontSize: 17, fontWeight: '700', letterSpacing: 0.2 },
  heroAlias: { color: 'rgba(255,255,255,0.4)', fontSize: 12, marginTop: 2, fontStyle: 'italic' },
  heroTags:  { flexDirection: 'row', flexWrap: 'wrap', gap: 6, marginTop: 7 },
  heroTag: {
    backgroundColor: 'rgba(255,255,255,0.07)',
    borderRadius: 6, paddingHorizontal: 8, paddingVertical: 3,
    borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)',
  },
  heroTagAccent:     { backgroundColor: 'rgba(229,62,109,0.12)', borderColor: 'rgba(229,62,109,0.3)' },
  heroTagText:       { color: 'rgba(255,255,255,0.55)', fontSize: 11, fontWeight: '600' },
  heroTagTextAccent: { color: '#E53E6D' },
  ...
  threatBadgeText:  { fontSize: 15, fontWeight: '800', letterSpacing: 0.5 },
  threatBadgeLabel: { fontSize: 9, fontWeight: '700', letterSpacing: 1.2, marginTop: 1, opacity: 0.7 },
  ...
  closeBtnText: { color: 'rgba(255,255,255,0.5)', fontSize: 13, fontWeight: '700', lineHeight: 16 },
  ...
  riskRow: {
    ...
    borderBottomWidth: 1, borderBottomColor: 'rgba(255,59,48,0.12)',
  },
  riskFlag: {
  ...
  riskFlagText: { color: '#FF6B6B', fontSize: 11, fontWeight: '600' },
  ...
  // ── Section header ──
  sectionHeader:     { flexDirection: 'row', alignItems: 'center', gap: 8, marginTop: 22, marginBottom: 10 },
  sectionHeaderIcon: { fontSize: 14 },
  sectionHeaderText: {
    color: 'rgba(255,255,255,0.5)', fontSize: 11,
    fontWeight: '700', letterSpacing: 0.8, textTransform: 'uppercase',
  },
  sectionHeaderLine: { flex: 1, height: 1, backgroundColor: 'rgba(255,255,255,0.07)', marginLeft: 4 },
  ...
  infoLabel:          { color: 'rgba(255,255,255,0.35)', fontSize: 12, fontWeight: '600', letterSpacing: 0.3, flexShrink: 0 },
  infoValue:          { color: 'rgba(255,255,255,0.8)', fontSize: 13, fontWeight: '500', flex: 1, textAlign: 'right' },
  infoValueHighlight: { color: '#FFFFFF', fontWeight: '600' },

  // ── Text card ──
  textCard:        { backgroundColor: '#161F2E', borderRadius: 14, borderWidth: 1, borderColor: 'rgba(255,255,255,0.07)', padding: 16 },
  textCardContent: { color: 'rgba(255,255,255,0.7)', fontSize: 14, lineHeight: 22 },

  // ── Note card ──
  noteCard:        { backgroundColor: 'rgba(229,62,109,0.05)', borderRadius: 14, borderWidth: 1, borderColor: 'rgba(229,62,109,0.2)', padding: 16 },
  noteCardContent: { color: 'rgba(255,255,255,0.65)', fontSize: 14, lineHeight: 22 },

  // ── Evidence ──
  downloadAllBtn: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center',
    backgroundColor: 'rgba(229,62,109,0.1)',
    borderRadius: 12, borderWidth: 1, borderColor: 'rgba(229,62,109,0.3)',
  ...
  downloadAllText:    { color: '#E53E6D', fontWeight: '700', fontSize: 13 },

  evidenceGroup:      { marginBottom: 12 },
  evidenceGroupLabel: {
    color: 'rgba(255,255,255,0.3)', fontSize: 10, fontWeight: '700',
    letterSpacing: 1, textTransform: 'uppercase', marginBottom: 6, marginLeft: 2,
  },
  evidenceList: {
    backgroundColor: '#161F2E',
  ...
  evidenceRow:       { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 14, paddingVertical: 12, gap: 12 },
  evidenceRowBorder: { borderBottomWidth: 1, borderBottomColor: 'rgba(255,255,255,0.05)' },
  evidenceIconWrap:  { width: 36, height: 36, borderRadius: 8, backgroundColor: 'rgba(255,255,255,0.05)', alignItems: 'center', justifyContent: 'center' },
  evidenceIcon:      { fontSize: 18 },
  evidenceMeta:      { flex: 1 },
  evidenceType:      { color: 'rgba(255,255,255,0.4)', fontSize: 10, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.6 },
  evidenceLabel:     { color: 'rgba(255,255,255,0.7)', fontSize: 12, marginTop: 2, fontWeight: '500' },
  downloadBtn: {
    paddingHorizontal: 14, paddingVertical: 7,
    borderRadius: 20, borderWidth: 1, borderColor: 'rgba(229,62,109,0.4)',
    backgroundColor: 'rgba(229,62,109,0.1)',
  ...
  progressTrack: { height: 2, borderRadius: 1, backgroundColor: 'rgba(255,255,255,0.08)', marginTop: 5, overflow: 'hidden' },
  progressFill:  { height: 2, borderRadius: 1, backgroundColor: '#E53E6D' },
});